...
public class MovSIAX extends Instruction {
	...
	public static final String REGEX = "^(" + AZMRegexCommon.NAME_RGX + " )?" + MNEMONIC + " SI AX$";
	...
	static public MovSIAX makeMovSIAX(String from) throws ExecutionException {
