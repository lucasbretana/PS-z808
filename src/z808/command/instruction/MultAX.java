...
public class MultAX extends Instruction {
	public static final int OPCODE = 0XF7E0;
	...
	public MultAX (String label) {
		this.size = MultAX.SIZE;
		this.label = label;

		this.code = MultAX.OPCODE;
		return;
	}
	...
	public void exec (Memory mem)
		...
		// 7. Execution
		mem.DX.set( (mem.AX.get() * mem.AX.get()) / 0x10000 );
		mem.AX.set( (mem.AX.get() * mem.AX.get()) % 0x10000 );
